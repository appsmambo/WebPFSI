			...
			<div class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					<div class="row visible-sm visible-md visible-lg">
						...
						<div class="col-sm-6 relativo">
							<a title="<?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>">
								<img src="<?php echo get_template_directory_uri() ?>/images/icono-home.png" alt="<?php bloginfo('name'); ?>" class="link-home">
							</a>
						</div>
					</div>
					<div class="navbar-header visible-xs">
						...
						<a class="navbar-brand col-xs-6" title="<?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>">
							<img src="<?php echo get_template_directory_uri() ?>/images/logo.jpg" alt="<?php bloginfo('name'); ?>" class="img-responsive">
						</a>
					</div>
